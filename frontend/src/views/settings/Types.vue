    ...
    <b-col lg="12">
      <b-card header="新規追加">
        <b-form inline onsubmit="return false;">
          <label class="mr-sm-2" for="inlineInput1">タイプ:</label>
      ...
      <c-table bordered caption="Types" :fields="fields" :items="items" :sort-by.sync="sortBy" @delete-id="delete_column" @edit-id="edit_column"></c-table>
    </b-col>
  </div>
</template>
